...
<div className='flex justify-center mt-[15%] w-full supermediumf  items-center'><h1>Welcome to teacher dashboard</h1></div>
...
export default WelcomeTeacherLogin