...
export const CSSTabs = ({ tabs, selectedTabIndex, setSelectedTab }) => {
    ...
    if (navRect && hoveredRect) {
        hoverStyles.transform = `translate3d(${hoveredRect.left -
            navRect.left}px,${hoveredRect.top - navRect.top}px,0px)`
    ...
    if (navRect && selectedRect) {
        ...
        selectStyles.transform = `translateX(calc(${selectedRect.left -
            navRect.left}px + 10%))`
